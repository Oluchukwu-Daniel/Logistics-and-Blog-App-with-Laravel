                                ...
                                <div class="row">
                                  ...
                                  {{-- <div class="col-lg-6">
                                      <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            <a href="quote.html" class="boxed-btn"><span>Track Parcel</span></a>
                                        </div>
                                      </div>
                                  </div> --}}
                                </div>
				...
				<div class="row">
                        ...
                        @csrf
												<div class="row">
													...
													<div class="col-md-6 col-lg-12">
															<div class="form-element col-lg-8"><input name="email" type="email" placeholder="Email"></div>
													</div>
													<div class="col-md-6 col-lg-12">
															<div class="form-element col-lg-8"><input name="password" type="password" placeholder="Password"></div>
													</div>
                          <div class="col-md-6 col-lg-12">
                            <div class="row">
                              <div class="col-lg-3 ">
                              ...
                              <div class="col-lg-8 ">
                                <div class="form-element mb-0 col-lg-8"><button type="submit" class="boxed-btn"><span>Forgot Password</span></button></div>
                              </div>
                            </div>
                          </div> 
												</div>
